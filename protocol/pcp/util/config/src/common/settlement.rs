...
const DEFAULT_PCP_CONTRACT_ADDRESS: &str = "0x5fc8d32690cc91d4c39d9d3abcbd16989f875707";
...
pub struct Config {
	...
	#[serde(default = "default_pcp_contract_address")]
...
env_default!(
	...
	String,
	DEFAULT_PCP_CONTRACT_ADDRESS.to_string()
);

env_default!(default_settlement_admin_mode, "PCP_SETTLEMENT_ADMIN_MODE", bool, false);

env_default!(default_settlement_super_block_size, "PCP_SETTLEMENT_SUPER_BLOCK_SIZE", u64, 1);
...
impl Default for Config {
	fn default() -> Self {
		Config {
			...
			pcp_contract_address: default_pcp_contract_address(),
