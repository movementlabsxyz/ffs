...
pub struct Config {
	...
	#[serde(default = "default_pcp_testing_admin_account_private_key")]
	pub pcp_testing_admin_account_private_key: String,
...
env_short_default!(default_pcp_testing_admin_account_private_key, String, "0x0");
...
impl Default for Config {
	fn default() -> Self {
		Config {
			...
			pcp_testing_admin_account_private_key: default_pcp_testing_admin_account_private_key(),
